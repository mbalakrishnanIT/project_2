//machine condition checklist program
//developed by balakrishnan.m
import java.awt.*;
import java.io.File;
...
{
    public
    Machine_conditioncheck() {  // collect the information from the empolye
        ...
        bu.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){ 
                try{
                    File file = new File("/path/"+jtff.getText()+"_Signed"+".txt");///home/g/Desktop
                    ...
                    if(chs==true){
                        FileWriter fw = new FileWriter(file);//write the user information.create the text file
                        fw.write("Name     :");
